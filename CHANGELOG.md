...
- Post-`CanStartMemming` follow-up gate validation now accepts the bounded proven two-hop hotpatch thunk chain `0x8db151 -> 0x8db146 -> 0x8dc0f5` instead of requiring the first thunk hop to land directly on the real body.
