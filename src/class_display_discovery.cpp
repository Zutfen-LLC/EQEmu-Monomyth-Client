...
constexpr std::uint32_t kGetClassThreeLetterCodeRva = 0x00042C00;
constexpr std::array<std::uint8_t, 32> kGetClassThreeLetterCodeEntryBytes = {{
    0x8B, 0x0D, 0x90, 0x27, 0xB8, 0x00, 0xB8, 0x67,
    0x66, 0x66, 0x66, 0xF7, 0xE9, 0xC1, 0xFA, 0x02,
    0x8B, 0xC2, 0xC1, 0xE8, 0x1F, 0x03, 0xC2, 0x56,
    0x8D, 0x04, 0x80, 0x03, 0xC0, 0x8B, 0xF1, 0x2B,
}};
